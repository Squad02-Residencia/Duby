...
const routes = [
  ...
  // Cliente
  { path: '/dashboard', name: 'Dashboard', component: DashboardPage, meta: { requiresAuth: true, role: 'client' } },
  { path: '/gerir-taxas', name: 'GerirTaxas', component: GerirTaxas, meta: { requiresAuth: true, role: 'client' } },
  { path: '/informacoes-financeiras', name: 'InformacoesFinanceiras', component: InformacoesFinanceiras, meta: { requiresAuth: true, role: 'client' } },
];
